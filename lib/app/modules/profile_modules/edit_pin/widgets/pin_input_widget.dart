...
import 'package:idoo/app/modules/profile_modules/edit_pin/controllers/edit_pin_controller.dart';

class PinInputWidget extends GetView<EditPinController> {
  PinInputWidget(this.title);
